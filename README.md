...
用于整理和演示 SAPUI5 自动化测试相关样例，仓库当前包含一个最小模板、一个完整 Demo，以及辅助测试脚本。

## 目录说明

- `sapui5-autotest-template`: SAPUI5 自动化测试最小模板，包含 QUnit、OPA5 和 wdi5。
- `sapui5-testing-demo`: 基于 SAPUI5 Testing Tutorial 整理的完整示例，包含 Mock Server、单元测试、集成测试和端到端测试。
- `test脚本`: 额外测试脚本或实验性内容。
...
- `test:e2e` 依赖本机 Chrome/Chromedriver 环境。
